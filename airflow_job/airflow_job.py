...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-rohesen")
    bq_project = Variable.get("bq_project", default_var="horizontal-data-464415-v6")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "846956119475-compute@developer.gserviceaccount.com",
                "network_uri": "projects/horizontal-data-464415-v6/global/networks/default",
                "subnetwork_uri": "projects/horizontal-data-464415-v6/regions/us-central1/subnetworks/default",
            }
        },
    }
